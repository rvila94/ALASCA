...
import equipments.fan.simulations.events.AbstractFanEvent;
...
implements FanSimulationOperationI
{
	...
	public void setHigh() {
		assert this.currentState == FanState.ON;
		assert this.currentMode  != FanMode.HIGH;
	...
	public void setMedium() {
		assert this.currentState == FanState.ON;
		assert this.currentMode  != FanMode.MEDIUM;
	...
	public void setLow() {
		assert this.currentState == FanState.ON;
		assert this.currentMode  != FanMode.LOW;
