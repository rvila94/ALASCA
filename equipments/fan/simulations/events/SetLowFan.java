...
extends		AbstractFanEvent
{
     ...
     * @param event
     */
    protected static boolean implementationInvariants(SetLowFan event) {
	...
	public void				executeOn(AtomicModelI model)
	{
        ...
        assert fan_model.getMode() != FanMode.LOW :
            new NeoSim4JavaException("fan_model.getMode() != Fan.FanMode.LOW");
    ...
    protected PriorityIndex priorityIndex() {
        return PriorityIndex.SetLowEvent;
    }
}
// -----------------------------------------------------------------------------
