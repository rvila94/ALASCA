...
extends		AbstractFanEvent
{
     ...
     * @param event
     */
    protected static boolean implementationInvariants(SwitchOnFan event) {
	...
	public void				executeOn(AtomicModelI model)
	{
        ...
        assert fan_model.getState() == FanState.OFF :
                new NeoSim4JavaException("fan_model.getState() != Fan.FanState.OFF");
