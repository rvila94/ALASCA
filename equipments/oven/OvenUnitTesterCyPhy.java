...
/**
 * The class <code>OvenUnitTesterCyPhy</code> implements a component performing 
...
public class OvenUnitTesterCyPhy 
extends AbstractCyPhyComponent {
    ...
    protected void initialise(
        ...
        if (VERBOSE) {
            this.tracer.get().setTitle("Oven test component");
    ...
    public synchronized void	execute() throws Exception {
        this.traceMessage("Oven Unit Tester begins execution.\n");

        switch (this.getExecutionMode()) {
            case STANDARD:
            case UNIT_TEST:
                this.statistics = new TestsStatistics();
                this.traceMessage("Oven Unit Tester CyPhy starts the tests.\n");
                this.runAllUnitTests();
                this.traceMessage("Oven Unit Tester CyPhy ends.\n");
                break;
