...
/**
 * The class <code>connections.HeatPump.equipments.HeatPumpExternalControlOutboundPort</code>.
 *
...
implements HeatPumpExternalControlCI {
    ...
    public SignalData<Double> getCurrentTemperature() throws Exception {
        System.out.println("CURRENT OUTBOUND");
        return ((HeatPumpExternalControlCI)this.getConnector()).getCurrentTemperature();
    }

    @Override
    public Measure<Double> getTargetTemperature() throws Exception {
        return ((HeatPumpExternalControlCI)this.getConnector()).getTargetTemperature();
    }
